namespace Tidy.Core
{
    ...
    internal static class AttrCheckImpl
    {
        static AttrCheckImpl()
        {
            CheckUrl = new UrlAttrCheck();
            CheckScript = new ScriptAttrCheck();
            CheckAlign = new AlignAttrCheck();
            CheckValign = new ValignAttrCheck();
            CheckBool = new BoolAttrCheck();
            CheckId = new IdAttrCheck();
            CheckName = new NameAttrCheck();
        }

        public static IAttrCheck CheckUrl { get; private set; }
        public static IAttrCheck CheckScript { get; private set; }
        public static IAttrCheck CheckAlign { get; private set; }
        public static IAttrCheck CheckValign { get; private set; }
        public static IAttrCheck CheckBool { get; private set; }
        public static IAttrCheck CheckId { get; private set; }
        public static IAttrCheck CheckName { get; private set; }
    }
}