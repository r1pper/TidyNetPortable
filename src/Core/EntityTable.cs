...
namespace Tidy.Core
{
    ...
    {
        private static EntityTable _defaultEntityTable;
        ...
        private readonly Dictionary<object, object> _entityHashtable = new Dictionary<object, object>();
        ...
        public static EntityTable DefaultEntityTable
        {
            get
            {
                if (_defaultEntityTable == null)
                {
                    ...
                    {
                        _defaultEntityTable.Install(entity);
                    }
                }
        ...
        {
            object entity = _entityHashtable.ContainsKey(ent.Name) ? _entityHashtable[ent.Name] : null;
        ...
        public virtual short EntityCode(string name)
        {
            ...
            return ent != null ? ent.Code : (short) 0;
        }
