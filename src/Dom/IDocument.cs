...
namespace Tidy.Dom
{
    ...
    internal interface IDocument : INode
    {
        ...
        ///     this is case-sensitive. For HTML, the
        ///     <name>tagNameThe</name>
        ///     <code>tagName</code>
        ...
        ///         <dd>
        ///             The <code>ownerElement</code> attribute
        ...
        ///         </dt>
        ///         <dd>
        ///             Only the <code>EntityReference</code> itself is
        ...
        ///             Note that the <code>deep</code> parameter has no effect on
        ///             <code>Notation</code> nodes since they never have any children.
        ///         </dd>
        ///         <dt>
        ...
        /// <param name="deep">
        ///     <code>true</code>, recursively import the subtree under
        ...
        ///     namespace URI of the element to create.
        /// </param>
        ...
        /// </summary>
        /// <param name="namespaceUri">
        ///     namespace URI of the attribute to create.
        /// </param>
        /// <param name="qualifiedName">
        ///     qualified name of the attribute to instantiate.
        /// </param>
        /// <returns>
