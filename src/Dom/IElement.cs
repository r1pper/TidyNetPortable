...
namespace Tidy.Dom
{
    ...
    internal interface IElement : INode
    {
        ...
        /// </summary>
        /// <param name="name">
        ///     name (<code>nodeName</code>) of the attribute to retrieve.
        /// </param>
        /// <returns>
        ///     The <code>Attr</code> node with the specified name (<code>nodeName</code>)
        ...
        ///     <cref>DOMException</cref>
        ///     <code>newAttr</code> was created from a
        ...
        /// </summary>
        /// <param name="oldAttr">
        ///     <code>Attr</code> node to remove from the attribute
        ///     list.
        /// </param>
        /// <returns>
